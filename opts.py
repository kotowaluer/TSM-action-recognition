...
parser.add_argument('modality', type=str, choices=['RGB', 'Flow', 'mono', 'combined'])
#parser.add_argument('tool', type=str, choices=['no_tool', 'with_tool'])
...
parser.add_argument('-j', '--workers', default=8, type=int, metavar='N',
                    help='number of data_origin loading workers (default: 8)')
